        ...
        methods: {
            submit() {
                const data = {
                    ...
                    client_id: 27,   //上面所说的client_id
                    client_secret: "2qlr0TvVuBaLpFf8rUIlQaTkEBQQLSGYVNNch1wx",//同上
            ...
            generateClient(){
                axios.post('http://127.0.0.1:8000/oauth/clients',{name:'98',redirect: 'http://127.0.0.1/home'})
                    .then(res => {
                        console.log(res)
                    })
            }
