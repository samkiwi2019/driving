...
/* harmony default export */ __webpack_exports__["default"] = ({
  computed: _objectSpread({}, mapState({
    isMobileBreakpoint: function isMobileBreakpoint(state) {
      return state.isMobileBreakpoint;
    }
  })),
  methods: _objectSpread(_objectSpread({}, mapActions(['setMobileBreakpoint'])), {}, {
    menuToggle: function menuToggle(evt) {
      evt.preventDefault();
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  computed: _objectSpread({}, mapState({
    ...
    showMobileMenu: function showMobileMenu(state) {
      return state.showMobileMenu;
    }
  })),
  methods: _objectSpread(_objectSpread({}, mapActions(['setShowMobileMenu'])), {}, {
    toggle: function toggle(evt) {
      evt.preventDefault();
      this.show = !this.show;
    },
    toggleMobilMenu: function toggleMobilMenu(evt) {
      evt.preventDefault();
...
var render = function() {
  ...
  return _c(
    "div",
    [_c("router-link", { attrs: { to: "/admin/menu" } }, [_vm._v("meny")])],
    1
  )
}
var staticRenderFns = []
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _modules_config__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/config */ "./resources/js/Vuex/modules/config.js");

/* harmony default export */ __webpack_exports__["default"] = ({
  modules: {
    config: _modules_config__WEBPACK_IMPORTED_MODULE_0__["default"]
  }
});

/***/ }),

/***/ "./resources/js/Vuex/modules/config.js":
/*!*********************************************!*\
  !*** ./resources/js/Vuex/modules/config.js ***!
  \*********************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _mutation_types__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../mutation-types */ "./resources/js/Vuex/mutation-types.js");
var _mutations;
...
var getters = {
  getIsMobileBreakpoint: function getIsMobileBreakpoint(state) {
    return state.isMobileBreakpoint;
  },
  getShowMobileMenu: function getShowMobileMenu(state) {
    return state.showMobileMenu;
  }
}; // actions

var actions = {
  setMobileBreakpoint: function setMobileBreakpoint(_ref, product) {
    var commit = _ref.commit,
        state = _ref.state;
    var isbreakpoint = window.matchMedia("(max-width: 991px )").matches;
    commit(_mutation_types__WEBPACK_IMPORTED_MODULE_0__["ISMOBILEBREAKPOINT"], isbreakpoint);
    isbreakpoint && commit(_mutation_types__WEBPACK_IMPORTED_MODULE_0__["SHOWMOBILEMENU"], isbreakpoint);
  },
  setShowMobileMenu: function setShowMobileMenu(_ref2, product) {
    var commit = _ref2.commit,
        state = _ref2.state;
    commit(_mutation_types__WEBPACK_IMPORTED_MODULE_0__["SHOWMOBILEMENU"], product);
  }
}; // mutations

var mutations = (_mutations = {}, _defineProperty(_mutations, _mutation_types__WEBPACK_IMPORTED_MODULE_0__["ISMOBILEBREAKPOINT"], function (state, products) {
  state.isMobileBreakpoint = products;
}), _defineProperty(_mutations, _mutation_types__WEBPACK_IMPORTED_MODULE_0__["SHOWMOBILEMENU"], function (state, product) {
...
/***/ "./resources/js/Vuex/mutation-types.js":
/*!*********************************************!*\
  !*** ./resources/js/Vuex/mutation-types.js ***!
  \*********************************************/
/*! exports provided: ISMOBILEBREAKPOINT, SHOWMOBILEMENU */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ISMOBILEBREAKPOINT", function() { return ISMOBILEBREAKPOINT; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SHOWMOBILEMENU", function() { return SHOWMOBILEMENU; });
var ISMOBILEBREAKPOINT = 'ISMOBILEBREAKPOINT';
...
var store = new vuex__WEBPACK_IMPORTED_MODULE_1__["default"].Store(_Vuex__WEBPACK_IMPORTED_MODULE_2__["default"]);
...
var routes = [{
  ...
  component: function component() {
    return __webpack_require__.e(/*! import() */ 4).then(__webpack_require__.bind(null, /*! ../components/admin/Layout */ "./resources/js/components/admin/Layout.vue"));
  },
  children: [{
    path: 'dashboard',
    component: function component() {
    ...
    path: 'list',
    component: function component() {
      return __webpack_require__.e(/*! import() */ 5).then(__webpack_require__.bind(null, /*! ../components/admin/ListQuiz */ "./resources/js/components/admin/ListQuiz.vue"));
    }
  }, {
    path: 'about',
    component: function component() {
      return __webpack_require__.e(/*! import() */ 0).then(__webpack_require__.bind(null, /*! ../components/admin/About */ "./resources/js/components/admin/About.vue"));
    }
  }]
}];
...
__webpack_require__(/*! /Users/liubin/php-workspace/driving/resources/js/app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! /Users/liubin/php-workspace/driving/resources/sass/app.scss */"./resources/sass/app.scss");
